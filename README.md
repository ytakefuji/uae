...
the number of predicted daily deaths due to the covid-19 in UAE as of Feb.15 2021.
In the graph, black line: the number of daily deaths, blue line: predicted curve using 330 days based on 10th degree polynomial curve-fitting, red line changing the number of days　from 100 to 330 days from Feb.15 2021 based on 5th degree polynomial curve-fitting.
